...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { employee_id: @office.employee_id, name: @office.name } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { employee_id: @office.employee_id, name: @office.name } }
