...
class QuantitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quantity" do
    assert_difference('Quantity.count') do
      post quantities_url, params: { quantity: { amount: @quantity.amount, product_id: @quantity.product_id, request_id: @quantity.request_id } }
    end
  ...
  test "should update quantity" do
    patch quantity_url(@quantity), params: { quantity: { amount: @quantity.amount, product_id: @quantity.product_id, request_id: @quantity.request_id } }
