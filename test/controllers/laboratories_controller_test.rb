...
class LaboratoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratory" do
    assert_difference('Laboratory.count') do
      post laboratories_url, params: { laboratory: { capacity: @laboratory.capacity, code: @laboratory.code, description: @laboratory.description, name: @laboratory.name } }
    end
  ...
  test "should update laboratory" do
    patch laboratory_url(@laboratory), params: { laboratory: { capacity: @laboratory.capacity, code: @laboratory.code, description: @laboratory.description, name: @laboratory.name } }
